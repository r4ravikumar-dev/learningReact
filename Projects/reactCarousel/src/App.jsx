...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-gray-700 to to-slate-900">
      ...
      <Carousel data={data} autoSlide= {true} className="m-4" />
      <div className="flex flex-wrap items-center justify-center text-center m-8">
