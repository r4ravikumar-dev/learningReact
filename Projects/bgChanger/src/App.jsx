  ...
  return (
    ...
    <div className='min-w-full min-h-screen duration-200' style={{backgroundColor: color}}>
      <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
        <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-gray-100 px-3 py-2 rounded-2xl border-2 border-violet-500'>
          ...
          <button onClick={() => setColor("pink")} className='outline-none px-4 py-1 rounded-full text-gray-600 shadow-lg' style={{backgroundColor: "pink"}}>Pink</button>
